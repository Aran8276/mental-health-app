    ...
    >
      ...
      >
        ...
        <motion.div variants={textContainerVariants}>
          ...
          >
            Selamat! Alamat email Anda telah berhasil diverifikasi. Anda
            selangkah lebih dekat untuk memulai perjalanan kesehatan mental
            Anda.
          </motion.p>
          <motion.p
            variants={textVariants}
          ...
          >
            Sekarang Anda dapat masuk ke akun Anda dan mulai menjelajahi fitur
            aplikasi.
          </motion.p>
        </motion.div>
