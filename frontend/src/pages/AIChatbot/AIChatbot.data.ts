// src/views/AIChatbot/AIChatbot.data.ts
...
export const sidebarVariant = {
  ...
  visible: { x: 0, opacity: 1, transition: { type: "tween", duration: 0.4, ease: "circOut" } },
  exit: { x: "-100%", opacity: 0, transition: { type: "tween", duration: 0.3, ease: "circIn" } },
};
...
export const listItemFade = {
  ...
  hover: { backgroundColor: "rgba(0, 128, 128, 0.08)", transition: { duration: 0.15 } }, // Teal subtle hover
  tap: { scale: 0.98 }
}
...
export const botBubbleColor = "bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100";
export const suggestionChipColor = "bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 hover:bg-purple-200 dark:hover:bg-purple-800/60";
export const sendButtonGradient = "bg-gradient-to-r from-teal-500 via-purple-500 to-teal-600 hover:from-teal-600 hover:via-purple-600 hover:to-teal-700";
export const sidebarBg = "bg-gradient-to-b from-white to-teal-50/50 dark:from-gray-800 dark:to-gray-900/80";
...
export const newChatButtonColor = "text-teal-700 dark:text-teal-300 hover:bg-teal-100/80 dark:hover:bg-teal-900/40 border-teal-200 dark:border-teal-700";