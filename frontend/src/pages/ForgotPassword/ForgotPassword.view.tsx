          ...
          {!emailSubmitted ? (
            ...
            >
              ...
              <motion.div variants={textContainerStagger}>
                ...
                >
                  Jangan khawatir! Masukkan alamat email Anda yang terdaftar,
                  dan kami akan mengirimkan tautan untuk mereset kata sandi
                  Anda.
                </motion.p>
              </motion.div>
            ...
            >
              ...
              <motion.div variants={textContainerStagger}>
                ...
                >
                  Kami telah mengirimkan tautan untuk mereset kata sandi Anda ke{" "}
                  <strong>{email}</strong>. Silakan periksa kotak masuk Anda.
                </motion.p>
                <motion.p
                  variants={textVariants}
                  className="text-xs text-gray-500 dark:text-gray-400 mb-8"
                >
                  Jika tidak menemukannya, periksa folder Spam atau tunggu
                  beberapa menit.
                </motion.p>
              </motion.div>
