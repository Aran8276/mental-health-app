          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="text-justify mx-auto max-w-3xl py-12">
              <div className="prose prose-gray space-y-8 dark:prose-invert max-w-none">
                <p className="lead">
                  Aplikasi Kesehatan Mental didirikan pada tahun 2020 dengan
                  visi yang sederhana namun kuat: menciptakan dunia di mana
                  setiap orang memiliki alat dan dukungan yang mereka butuhkan
                  untuk merawat kesejahteraan mental mereka.
                </p>
                <p>
                  Perjalanan kami dimulai ketika pendiri kami, Sarah Chen,
                  mengalami secara langsung tantangan dalam menemukan sumber
                  daya kesehatan mental yang mudah diakses selama masa sulit
                  dalam hidupnya. Menyadari bahwa jutaan orang menghadapi
                  hambatan serupa dalam mendapatkan layanan kesehatan mental,
                  dia membentuk tim yang terdiri dari para profesional kesehatan
                  mental, teknolog, dan desainer untuk menciptakan solusi.
                </p>
                <p>
                  Hari ini, Aplikasi Kesehatan Mental melayani lebih dari 10.000
                  pengguna di seluruh dunia, menyediakan alat berbasis bukti
                  untuk pelacakan suasana hati, meditasi, terapi perilaku
                  kognitif, dan dukungan komunitas. Kami percaya bahwa layanan
                  kesehatan mental harus dapat diakses, dipersonalisasi, dan
                  bebas dari stigma.
                </p>
                <blockquote>
                ...
                <p>
                  ...
                  aplikasi berdasarkan umpan balik pengguna dan penelitian
                  terbaru dalam bidang kesehatan mental.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
                  Nilai-nilai inti kami membimbing segala hal yang kami lakukan
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Psikolog klinis yang mengkhususkan diri dalam terapi
                    perilaku kognitif dan mindfulness.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Mental health advocate with experience in building
            ...
            <div className="grid gap-10 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-xl">
                  Dari startup kecil hingga platform kesejahteraan mental
                  global.
                </p>
                <div className="space-y-4">
